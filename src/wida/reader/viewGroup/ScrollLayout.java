...
public class ScrollLayout extends ViewGroup {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE:
			...
			mLastMotionX = x;
			//第一页不左移动 最后一页不右移动
		//	if((mCurScreen == 0 && deltaX < 0 ) || (mCurScreen == (getChildCount()-1) && deltaX > 0) ) break;
			Log.v(TAG, "deltaX:"+deltaX+", mCurScreen:"+ mCurScreen + ",getChildCount" + getChildCount());
			scrollBy(deltaX, 0);
			break;
